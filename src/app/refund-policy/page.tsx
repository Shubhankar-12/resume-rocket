  ...
  const refundSteps = [
    {
      ...
      description: "Contact our support team or use the self-service option in your account",
    },
    {
      step: "2",
      title: "Verification",
      description: "We verify your request and confirm eligibility within 24 hours",
    },
    {
      step: "3",
      title: "Processing",
      description: "Refund is processed and sent to your original payment method",
    },
    {
      step: "4",
      title: "Confirmation",
      description: "You receive confirmation and the refund appears in 3-5 business days",
    },
  ];
        ...
        <section ref={heroRef} className="py-20 md:py-32 relative overflow-hidden">
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              >
                We stand behind our service with a comprehensive refund policy. Your satisfaction is
                our priority, and we make returns simple and hassle-free.
              </motion.p>
              <motion.div
                variants={itemVariants}
          ...
          <div className="container px-4 md:px-6">
            ...
            >
              <motion.div variants={itemVariants} className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Refund Guarantee</h2>
                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none">
                      <motion.section variants={itemVariants} className="mb-12">
                        ...
                        <p className="text-muted-foreground mb-4">
                          We offer a 14-day money-back guarantee for all paid subscriptions. You are
                        ...
                        <p className="text-muted-foreground mt-4">
                          <strong>Note:</strong> Free accounts are not eligible for refunds as no
                          payment was made.
                        </p>
                      </motion.section>

                      <motion.section variants={itemVariants} className="mb-12">
                        <h2 className="text-2xl font-bold mb-4 text-primary">2. Refund Process</h2>
                        <div className="space-y-4">
                          <div>
                            <h3 className="text-lg font-semibold mb-2">How to Request</h3>
                      ...
                      <motion.section variants={itemVariants} className="mb-12">
                        ...
                        <div className="space-y-4">
                          <div>
                            <h3 className="text-lg font-semibold mb-2">Review Period</h3>
                            <p className="text-muted-foreground">
                              We will review your refund request within 24 hours of submission. Most
                              requests are approved automatically if they meet our eligibility
                              criteria.
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-muted-foreground">
                              Once approved, refunds are processed within 1-2 business days. The
                              time it takes for the refund to appear in your account depends on your
                              payment method:
                            </p>
                      ...
                      <motion.section variants={itemVariants} className="mb-12">
                        <h2 className="text-2xl font-bold mb-4 text-primary">4. Refund Amount</h2>
                        <div className="space-y-4">
                          <div>
                            <h3 className="text-lg font-semibold mb-2">Full Refund</h3>
                            <p className="text-muted-foreground">
                              You will receive a 100% refund of the amount paid for your
                          ...
                          <div>
                            <h3 className="text-lg font-semibold mb-2">Processing Fees</h3>
                            <p className="text-muted-foreground">
                              We absorb all processing fees associated with refunds. You will not be
                              charged any additional fees for processing your refund.
                            </p>
                          </div>
                        </div>
                      </motion.section>
                      ...
                      <motion.section variants={itemVariants} className="mb-12">
                        ...
                        <p className="text-muted-foreground mb-4">Once a refund is processed:</p>
                        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                      ...
                      <motion.section variants={itemVariants} className="mb-12">
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground">
                              In exceptional circumstances, we may offer partial refunds for annual
                              subscriptions based on unused time. These are evaluated on a
                              case-by-case basis.
                            </p>
                          </div>
                        </div>
                      ...
                      <motion.section variants={itemVariants} className="mb-12">
                        ...
                        <p className="text-muted-foreground">
                          ...
                          on this page with an updated "Last modified" date. Continued use of our
                ...
                <Card className="shadow-xl border-primary/10 bg-gradient-to-br from-primary/5 to-secondary/5">
                  <CardContent className="p-8">
                    <div className="space-y-6">
                      ...
                      <h3 className="text-2xl font-bold">Need Help with a Refund?</h3>
                      <p className="text-muted-foreground">
                        Our customer support team is here to help you with any refund questions or
                        requests. We're committed to making the process as smooth as possible.
                      </p>
                      <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        >
                          <a href="mailto:refunds@resumerocket.com">Request Refund</a>
                        </Button>
