...
export function ConsentBanner() {
  ...
  return (
    <div
      ...
      className="fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-3xl rounded-lg border border-border bg-background/95 p-4 shadow-lg backdrop-blur print:hidden md:p-5"
    >
